...
| 8           | Lift movement timeout - Lift did not reach destination floor after 2 minutes           | 1. Lift goes back to manual mode. <br/>2 . PLC state goes to error state.                                       | Manual intervention is needed. PLC will stay in error state until it is restarted.                             |
